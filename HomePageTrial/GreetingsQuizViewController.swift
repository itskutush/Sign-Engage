...
class GreetingsQuizViewController: UIViewController {
    ...
    func playVideo(for question: GreetingsQuizDataModel) {
    ...
    @IBAction func nextButtonTapped(_ sender: UIButton) {
        ...
        if currentQuestionIndex < quizQuestions.count {
            ...
            performSegue(withIdentifier: "showGreetingsQuizCompletionScreen", sender: nil)
        }
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showGreetingsQuizCompletionScreen" {
            let destinationVC = segue.destination as! GreetingsQuizCompletionViewController
            destinationVC.GreetingsQuizTotalScore = correctAnswersCount 
        }
    }
}
