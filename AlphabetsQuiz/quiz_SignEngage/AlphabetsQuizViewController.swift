...
class AlphabetsQuizViewController: UIViewController {
    ...
    func playVideo(for question: AlphabetsQuizQuestion) {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showAlphabetsQuizCompletionScreen" {
            let destinationVC = segue.destination as! AlphabetsCompletionViewController
            destinationVC.totalScore = correctAnswersCount 
        }
    }
}
